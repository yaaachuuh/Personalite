...
Built as part of the Hack Club Stardance challenge, and as an early concept piece for DRIVEN, a larger car-experience project I'm building.
What it does
...
Serve it with a local server — e.g. the Live Server VS Code extension, right-click index.html → "Open with Live Server"
Note: you can't just double-click index.html and open it as a file:// URL — the 3D model won't load due to browser CORS restrictions on local file fetches. It needs to be served over http://.
Project structure
...
​
Credit
3D Model: "2024 Redbull RB20" by Dave Love on Sketchfab, licensed under CC Attribution 4.0.
View original model →
Dev log
